    ...
    switch (action) {
      ...
      case 'ship': {
        ...
        if (!data?.alreadyShipped) {
          try {
            ...
            console.error(
              `[order ship] shipping confirmation email failed for ${id}:`,
              shipEmailErr,
            )
          }
        }
      ...
      case 'return': {
        ...
        try {
          ...
          if (
            refundAmountOverride !== undefined &&
          ...
          if (order.email) {
            try {
              ...
              console.error(
                `[order return] refund confirmation email failed for ${id}:`,
                refundEmailErr,
              )
            }
          }
        ...
        try {
          ...
          if (order.email) {
            try {
              ...
              console.error(
                `[order approve-return] refund confirmation email failed for ${id}:`,
                refundEmailErr,
              )
            }
          }
