...
const FIELDS = 'id,status,code,value,currency_code,line_item_id,reference_id,reference,expires_at,note,updated_at,created_at,metadata';
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const res = await fetch(`${MEDUSA_URL}/admin/gift-cards?fields=${encodeURIComponent(FIELDS)}`, {
      method: 'POST',
      headers: {
        Authorization: authorization,
