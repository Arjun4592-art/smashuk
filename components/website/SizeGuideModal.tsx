...
const SHOE_SIZES = [
  ...
  { uk: '6', eu: '39.5', us_m: '7', us_w: '8.5', cm: '25' },
  { uk: '7', eu: '41', us_m: '8', us_w: '9.5', cm: '26' },
  { uk: '8', eu: '42', us_m: '9', us_w: '10.5', cm: '27' },
  { uk: '9', eu: '43.5', us_m: '10', us_w: '11.5', cm: '28' },
  { uk: '10', eu: '44.5', us_m: '11', us_w: '12.5', cm: '29' },
  { uk: '11', eu: '46', us_m: '12', us_w: '13.5', cm: '30' },
  { uk: '12', eu: '47', us_m: '13', us_w: '14.5', cm: '31' },
]

const APPAREL_SIZES = [
  { size: 'XS', chest: '81-86', waist: '66-71' },
  { size: 'S', chest: '86-91', waist: '71-76' },
  { size: 'M', chest: '91-97', waist: '76-82' },
  { size: 'L', chest: '97-104', waist: '82-89' },
  { size: 'XL', chest: '104-112', waist: '89-97' },
  { size: 'XXL', chest: '112-120', waist: '97-105' },
]

export default function SizeGuideModal({ onClose, initialTab = 'shoes' }: Props) {
    ...
    >
      ...
      >
        ...
        <div className='flex gap-2 px-6 pt-5'>
          {(['shoes', 'apparel'] as const).map((t) => (
            <button
              key={t}
              onClick={() => setTab(t)}
              className={`px-4 py-1.5 rounded-full text-xs font-montserrat font-bold capitalize transition-colors ${
                tab === t
            ...
            <>
              ...
              <div className='overflow-x-auto'>
                <table className='w-full text-xs font-lato text-center border-collapse'>
                  ...
                  <tbody>
                    {SHOE_SIZES.map((row) => (
                      <tr key={row.uk} className='border-b border-gray-100 text-gray-600'>
                ...
                <table className='w-full text-xs font-lato text-center border-collapse'>
                  ...
                  <tbody>
                    {APPAREL_SIZES.map((row) => (
                      <tr key={row.size} className='border-b border-gray-100 text-gray-600'>
