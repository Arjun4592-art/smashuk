...
export default function ContactPage() {
  ...
  const CONTACT_CARDS = [
    ...
    },
    {
      ...
      label: 'Hours',
      value: 'Mon–Sat 11am–7pm · Sun closed',
    },
  ]
  return (
                ...
                const inner = (
                  <div className='flex items-start gap-3.5 p-4 group'>
                    ...
                    <div className='min-w-0'>
                      ...
                      <p
                        className={`text-sm font-montserrat font-bold text-[#0A1F44] leading-snug break-words ${c.href ? 'group-hover:text-[#E8553A] transition-colors' : ''}`}
                      >
                        {c.value}
                      </p>
                    </div>
