          ...
          <div className='flex-1 min-w-0'>
            ...
            <div className='flex items-center justify-between gap-3 flex-wrap'>
              ...
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-black font-montserrat transition-all duration-200 ${!product.inStock ? 'bg-[#F2F4F7] text-[#9CA3AF] cursor-not-allowed' : added ? 'bg-[#10B981] text-white' : 'bg-[#0A1F44] hover:bg-[#E8553A] text-white shadow-sm'}`}
              >
          ...
          <div className='relative aspect-square bg-[#F2F4F7] overflow-hidden'>
            ...
            <div className='absolute inset-0 bg-[#0A1F44]/50 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end justify-center pb-5 gap-3'>
              ...
              <button
                ...
                title={hasMultipleVariants ? 'Choose options' : 'Add to cart'}
                className={`w-10 h-10 rounded-full flex items-center justify-center transition-all shadow-lg translate-y-4 group-hover:translate-y-0 duration-300 ${added ? 'bg-[#10B981] text-white' : 'bg-white text-[#0A1F44] hover:bg-[#E8553A] hover:text-white'}`}
              >
