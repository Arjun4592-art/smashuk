...
const TIERS = [
  ...
  },
  {
    ...
    items: [
      ...
      'Deeper equipment discounts',
      'Demo access & event support',
    ],
  },
  {
    icon: '🏟️',
    ...
    items: [
      'Clubs & teams',
      'Kit support',
      'Member discounts & event sponsorship',
    ],
  },
  {
    icon: '🎯',
    ...
    items: [
      'Coaches running sessions or academies',
      'Equipment support for your players',
    ],
  },
]
