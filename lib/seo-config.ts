...
export const DEFAULT_SEO: Record<string, any> = {
  home: {
    ...
    metaDescription: 'Shop premium sports equipment for badminton, squash, tennis, padel and more. Free UK delivery over £50.',
    metaKeywords: 'sports equipment uk, badminton rackets, squash rackets, sports shop uk, smash racket pro',
    ogImage: '',
  ...
  shop: {
    ...
    metaDescription: 'Browse premium sports products across all categories. Best prices with free delivery over £50.',
    metaKeywords: 'buy sports online uk, sports equipment shop, smash racket pro',
    ogImage: '',
  ...
  about: {
    ...
    metaDescription: 'Smash Racket Pro is your trusted UK sports equipment store. We stock premium gear for all racket sports.',
  ...
  contact: {
    ...
    metaDescription: 'Get in touch with Smash Racket Pro for orders, returns, and enquiries.',
  ...
  'local-store': {
    metaTitle: 'Manchester Racket Store — Restringing, Demo & Advice | Smash Racket Pro',
    metaDescription: 'Visit our Manchester racket specialist store for badminton, tennis, squash and padel. Same/next-day racket restringing, free expert advice from club-level players, and a racket demo service so you can try before you buy.',
    metaKeywords: 'manchester racket shop, racket restringing manchester, badminton restring manchester, tennis racket restring, racket stringing service uk, racket demo service, badminton shop manchester, tennis shop manchester, padel shop manchester, squash shop manchester, racket sports store near me, string a racket manchester, hulme high street sports shop',
    ogImage: '',
