...
export default function DiscountsPage() {
  ...
  const { data, loading, error, refetch } = useDiscounts({
    limit: 100,
  })
                      ...
                      <td className='px-4 py-3.5'>
                        <div className='flex items-center gap-2'>
                          ...
                          <button
                            ...
                            className={`w-6 h-6 flex items-center justify-center rounded transition-all duration-150 bg-transparent border-none cursor-pointer ${copiedId === discount.id ? 'text-[#008060] bg-[#F2F7F5]' : 'text-[#B0B5BA] hover:text-[#008060] hover:bg-[#F2F7F5]'}`}
                            title='Copy code'
                          >
                        ...
                        <p
                          className={`text-[11px] mt-1 max-w-[200px] truncate ${discount.description ? 'text-[#B0B5BA]' : 'text-[#D0855A] italic'}`}
                        >
                          {discount.description ||
                            'No description — add one to identify this code'}
                        </p>
                      </td>
