...
const PROCESS = [
  ...
  },
  {
    step: '02',
    title: 'Consultation',
    desc: "We talk through your level, playing style, and what has or hasn't worked before.",
    icon: <IconConsult />,
  },
  {
    step: '03',
    title: 'Stringing',
    desc: 'Strung on our fully-automatic machine to your exact tension spec — no shortcuts.',
    icon: <IconString />,
  },
  {
    step: '04',
    title: 'Quality Check',
    desc: 'Tension verified, pattern checked, frame inspected before we sign off.',
    icon: <IconCheck />,
  },
  {
    step: '05',
    title: 'Collection',
    desc: "We message you when it's ready, with tips on how to maintain your new strings.",
    icon: <IconCollect />,
  },
]
      ...
      <div className='ls-hero ls-hero-noise relative text-white overflow-hidden'>
        ...
        <div className='relative max-w-4xl mx-auto px-6 py-20 text-center'>
          ...
          <h1 className='ls-hero-title font-montserrat font-black text-white text-4xl md:text-5xl leading-tight mb-4'>
            Precision Stringing.
            <br />
            <span className='text-[#FFC453]'>Every Time.</span>
          </h1>
          <p className='ls-hero-subtitle text-white/70 font-lato text-lg max-w-lg mx-auto mb-8'>
            From social players to competitive club level — we string to your
            exact spec, every time.
          </p>
      ...
      <div className='max-w-4xl mx-auto px-6 py-16 space-y-20'>
        ...
        <section className='reveal'>
          <div className='text-center mb-10'>
            ...
            <p className='text-gray-500 font-lato mt-3 max-w-md mx-auto'>
              Not sure what to ask for? Here's a starting point — our stringers
              will refine it with you in-store.
            </p>
          </div>
          <div className='grid grid-cols-1 md:grid-cols-3 gap-5'>
            {TENSIONS.map((t, i) => (
              <div
                key={t.level}
                className={`rounded-2xl p-6 border ${i === 1 ? 'bg-[#0A1F44] border-[#0A1F44]' : 'bg-white border-gray-100'}`}
              >
                <p
        ...
        <section className='reveal'>
          <div className='text-center mb-12'>
            ...
            <p className='text-gray-500 font-lato mt-3 max-w-md mx-auto'>
              Five steps, zero shortcuts. This is exactly what happens from the
              moment you drop off your racket.
            </p>
          </div>
        ...
        <section className='reveal'>
          ...
          <Link
            ...
            className='group flex flex-col sm:flex-row max-w-xl mx-auto bg-[#F8F9FB] rounded-2xl border border-gray-100 overflow-hidden hover:border-[#E8553A]/30 hover:shadow-[0_8px_24px_rgba(232,85,58,0.08)] transition-all'
          >
