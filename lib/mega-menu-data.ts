// Shared mega-menu data — used by both the top Navbar (search overlay,
    ...
    columns: [
      {
        ...
        links: [
          ...
          { label: 'Yonex', href: '/shop?sport=badminton&brand=yonex' },
          { label: 'Victor', href: '/shop?sport=badminton&brand=victor' },
          { label: 'Li-Ning', href: '/shop?sport=badminton&brand=li-ning' },
          { label: 'Babolat', href: '/shop?sport=badminton&brand=babolat' },
        ],
      },
      {
        heading: 'Shoes',
        links: [
          { label: 'All Shoes', href: '/shop?sport=badminton&category=shoes' },
          {
            label: 'Men',
      ...
      },
      {
        heading: 'Others',
        links: [
          { label: 'Racket Bags', href: '/shop?sport=badminton&category=bags' },
          {
            label: 'Shuttlecocks',
      ...
      },
      {
        ...
        links: [
          ...
          { label: 'Advanced', href: '/shop?sport=badminton&level=advanced' },
          {
            label: 'Head Heavy',
    ...
    columns: [
      {
        heading: 'Rackets',
        links: [
          { label: 'All Rackets', href: '/shop?sport=tennis&category=rackets' },
          { label: 'Babolat', href: '/shop?sport=tennis&brand=babolat' },
          { label: 'HEAD', href: '/shop?sport=tennis&brand=head' },
          { label: 'Yonex', href: '/shop?sport=tennis&brand=yonex' },
          { label: 'Junior Rackets', href: '/shop?sport=tennis&level=junior' },
        ],
      },
      {
        heading: 'Shoes',
        links: [
          { label: 'All Shoes', href: '/shop?sport=tennis&category=shoes' },
          {
            label: 'Men',
      ...
      },
      {
        ...
        links: [
          { label: 'Tennis Balls', href: '/shop?sport=tennis&category=balls' },
          { label: 'Tennis Bags', href: '/shop?sport=tennis&category=bags' },
          { label: 'Racket Grips', href: '/shop?sport=tennis&category=grips' },
        ],
      },
      {
        heading: 'Brand',
        links: [
          { label: 'Babolat Store', href: '/shop?brand=babolat' },
          { label: 'Yonex Store', href: '/shop?brand=yonex' },
          { label: 'HEAD Store', href: '/shop?brand=head' },
          { label: 'Wilson Store', href: '/shop?brand=wilson' },
        ],
      },
    ],
    featured: {
    ...
    columns: [
      {
        ...
        links: [
          { label: 'Adidas', href: '/shop?sport=padel&brand=adidas' },
          { label: 'Babolat', href: '/shop?sport=padel&brand=babolat' },
          { label: 'Bullpadel', href: '/shop?sport=padel&brand=bullpadel' },
          { label: 'HEAD', href: '/shop?sport=padel&brand=head' },
          { label: 'Tecnifibre', href: '/shop?sport=padel&brand=tecnifibre' },
          { label: 'Dunlop', href: '/shop?sport=padel&brand=dunlop' },
        ],
      },
      {
        heading: 'Popular',
        links: [
          { label: 'Sale Rackets', href: '/shop?sport=padel&badge=SALE' },
          { label: 'Best Sellers', href: '/shop?sport=padel&badge=BESTSELLER' },
          { label: 'New Arrivals', href: '/shop?sport=padel&badge=NEW' },
        ],
      },
      {
        heading: 'Others',
        links: [
          { label: 'Padel Balls', href: '/shop?sport=padel&category=balls' },
          { label: 'Padel Shoes', href: '/shop?sport=padel&category=shoes' },
          { label: 'Padel Bags', href: '/shop?sport=padel&category=bags' },
        ],
      },
    ],
    featured: {
    ...
    columns: [
      {
        heading: 'Rackets',
        links: [
          { label: 'All Rackets', href: '/shop?sport=squash&category=rackets' },
          { label: 'Dunlop', href: '/shop?sport=squash&brand=dunlop' },
          { label: 'HEAD', href: '/shop?sport=squash&brand=head' },
          { label: 'Wilson', href: '/shop?sport=squash&brand=wilson' },
        ],
      },
      {
        heading: 'Accessories',
        links: [
          { label: 'Squash Balls', href: '/shop?sport=squash&category=balls' },
          { label: 'Squash Bags', href: '/shop?sport=squash&category=bags' },
          { label: 'Racket Grips', href: '/shop?sport=squash&category=grips' },
        ],
      },
    ],
    featured: {
