// app/api/store/blogs/[slug]/route.ts
//
// Public single-post lookup by slug, used by app/(website)/blog/[slug]/page.tsx.
// Same assumptions as app/api/store/blogs/route.ts — needs a matching
// GET /store/blog-posts/:slug (or ?slug=) route on the Medusa backend.
