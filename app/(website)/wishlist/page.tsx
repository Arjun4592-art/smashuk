...
// Same subtle diagonal grid-line texture used on the shop page and every
// local-store hero/header — the wishlist header now matches that "strip"
// treatment instead of being a plain flat navy bar.
