    ...
    background: 'rgba(0,0,0,0.4)'
      ...
      boxShadow: '0 8px 32px rgba(0,0,0,0.12)'
        ...
        <div className='p-5'>
          ...
          <textarea autoFocus value={value} onChange={e => setValue(e.target.value)} placeholder='e.g. Customer requested gift wrapping, special instructions...' rows={4} className='w-full px-3 py-2.5 rounded-lg border text-sm outline-none resize-none transition-colors focus:border-[#008060]' style={{
          borderColor: '#E1E3E5',
          color: '#202223'
        }} />
        ...
        <div className='px-5 pb-5 flex gap-2'>
          {orderNote && <button onClick={handleClear} className='py-2.5 px-4 rounded-lg text-sm border transition-colors hover:bg-[#FFF4F4]' style={{
          borderColor: '#E1E3E5',
          color: '#D82C0D'
        }}>
              Clear
          ...
          <button onClick={handleSave} className='flex-1 py-2.5 rounded-lg text-sm font-semibold' style={{
          background: '#008060',
          color: '#FFFFFF'
        }}>
            Save note
