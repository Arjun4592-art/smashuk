                      ...
                      <td className='px-4 py-3.5'>
                        <div className='space-y-1.5'>
                          <div className='flex items-center gap-2'>
                            ...
                            <span
                              className={`text-[10px] font-semibold px-1.5 py-0.5 rounded-full ${status === 'out' ? 'bg-[#D82C0D]/8 text-[#D82C0D]' : status === 'low' ? 'bg-amber-50 text-amber-600' : 'bg-[#008060]/8 text-[#008060]'}`}
                            >
                              {status === 'out'
                                ? 'Out'
                                : status === 'low'
              ...
              <div className='grid grid-cols-3 gap-2'>
                {[
                  ...
                  <button
                    ...
                    className={`flex flex-col items-center gap-1.5 p-3 border-2 rounded-xl text-[12px] font-medium cursor-pointer transition-all duration-150 ${adjustType === t.value ? 'border-[#008060] bg-[#F2F7F5] text-[#008060]' : 'border-[#E1E3E5] bg-white text-[#8C9196] hover:bg-[#FAFAFA] hover:border-[#C4C8CC]'}`}
                  >
            ...
            <div className='px-6 py-5 space-y-4'>
              ...
              <div className='grid grid-cols-3 gap-2'>
                <button
                  ...
                  className={`py-2.5 rounded-lg text-[13px] font-medium border cursor-pointer transition-colors ${bulkType === 'add' ? 'border-[#008060] bg-[#008060]/8 text-[#008060]' : 'border-[#E1E3E5] text-[#6D7175] hover:bg-[#F6F6F7]'}`}
                >
                  + Add
                </button>
                <button
                  onClick={() => setBulkType('remove')}
                  className={`py-2.5 rounded-lg text-[13px] font-medium border cursor-pointer transition-colors ${bulkType === 'remove' ? 'border-[#D82C0D] bg-[#D82C0D]/8 text-[#D82C0D]' : 'border-[#E1E3E5] text-[#6D7175] hover:bg-[#F6F6F7]'}`}
                >
                  − Remove
                </button>
                <button
                  onClick={() => setBulkType('set')}
                  className={`py-2.5 rounded-lg text-[13px] font-medium border cursor-pointer transition-colors ${bulkType === 'set' ? 'border-[#2C6ECB] bg-[#2C6ECB]/8 text-[#2C6ECB]' : 'border-[#E1E3E5] text-[#6D7175] hover:bg-[#F6F6F7]'}`}
                >
                  = Set to
                </button>
              </div>
