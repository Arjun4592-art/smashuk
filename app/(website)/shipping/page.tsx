...
export default function DeliveryPage() {
  return (
    <LegalPage title='Delivery Information'>
      ...
      <p>
        Orders of £{FREE_SHIPPING_THRESHOLD} or more ship free. Orders below
        that have a flat Standard shipping fee of £
      ...
      <p>
        ...
        order includes a racket with a <strong>String Upgrade</strong> selected,
        please allow one extra day for stringing before dispatch.
      </p>

      <h2>Tracking your order</h2>
      <p>
        Once your order ships, you'll receive a tracking link by email. You can
        also see order status any time under{' '}
        <a
          href='/profile?tab=orders'
          className='text-[#E8553A] hover:underline'
        >
          My Orders
        </a>
        .
      ...
      <p>
        ...
        <a href='/contact' className='text-[#E8553A] hover:underline'>
          Contact page
        </a>{' '}
