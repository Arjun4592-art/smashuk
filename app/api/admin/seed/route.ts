...
const CATEGORY_TREE = [
  {
    ...
    handle: 'badminton',
    children: [
      { name: 'Badminton Rackets', handle: 'badminton-rackets' },
      { name: 'Badminton Shoes', handle: 'badminton-shoes' },
      { name: 'Badminton Racket Bags', handle: 'badminton-racket-bags' },
      { name: 'Shuttlecocks', handle: 'badminton-shuttlecocks' },
      { name: 'Racket Grips', handle: 'badminton-racket-grips' },
    ],
  },
  {
    name: 'Tennis',
    handle: 'tennis',
    children: [
      { name: 'Tennis Rackets', handle: 'tennis-rackets' },
      { name: 'Tennis Shoes', handle: 'tennis-shoes' },
      { name: 'Tennis Balls', handle: 'tennis-balls' },
      { name: 'Tennis Bags', handle: 'tennis-bags' },
      { name: 'Tennis Grips', handle: 'tennis-racket-grips' },
    ],
  },
  {
    name: 'Padel',
    handle: 'padel',
    children: [
      { name: 'Padel Rackets', handle: 'padel-rackets' },
      { name: 'Padel Balls', handle: 'padel-balls' },
      { name: 'Padel Shoes', handle: 'padel-shoes' },
      { name: 'Padel Bags', handle: 'padel-bag' },
    ],
  },
  {
    name: 'Clothing',
    handle: 'apparel',
    children: [
      { name: "Men's Clothing", handle: 'men-clothing' },
      { name: "Women's Clothing", handle: 'women-clothing' },
...
const PRODUCTS = [
  {
    ...
    variants: [
      { name: '3U (85-89g)', price: 189.99 },
      { name: '4U (80-84g)', price: 189.99 },
    ],
    description:
      'The Arcsaber 11 Pro delivers more power than its predecessor and still maintains manoeuvrability.',
    specifications: {
  ...
  },
  {
    ...
    sale_price: 189.99,
    regular_price: 220.0,
    variants: [{ name: 'Silver/Black', price: 189.99 }],
    description:
      'Yonex Astrox 88D Pro Generation 3 — head-heavy balance for powerful smashes.',
    specifications: {
      balance: 'Head-Heavy',
      player_level: 'Advanced Player',
      strung: false,
  ...
  },
  {
    ...
    sale_price: 44.99,
    regular_price: 50.0,
    variants: [{ name: 'Standard', price: 44.99 }],
    description:
      'Yonex ArcSaber 7 Play — great entry-level racket for developing players.',
    specifications: { player_level: 'Developing Player' },
  },
  {
    id: 'prod-004',
    ...
    sale_price: 184.99,
    regular_price: 220.0,
    variants: [{ name: 'Standard', price: 184.99 }],
    description: 'Yonex Astrox 77 Pro — head-heavy balance for attacking play.',
    specifications: { player_level: 'Advanced Player', balance: 'Head-Heavy' },
  },
  {
    id: 'prod-005',
    ...
    sale_price: 157.99,
    regular_price: 190.0,
    variants: [{ name: 'Standard', price: 157.99 }],
    description:
      'Yonex ArcSaber 7 Pro — precision control for advanced players.',
    specifications: { player_level: 'Advanced Player' },
  },
  {
    id: 'prod-006',
    ...
    variants: [{ name: 'Standard', price: 200.0 }],
  ...
  },
  {
    ...
    sale_price: 169.99,
    regular_price: 220.0,
    variants: [{ name: 'Standard', price: 169.99 }],
    description: 'Yonex Nanoflare 700 Pro — speed and control.',
    specifications: { player_level: 'Advanced Player', strung: false },
  },
  {
    id: 'prod-008',
    ...
    sale_price: 191.99,
    regular_price: 229.99,
    variants: [{ name: 'Standard', price: 191.99 }],
    description:
      'Yonex Astrox 88S Pro 3rd Gen — for net play and deceptive shots.',
    specifications: { player_level: 'Advanced Player', strung: false },
  },
  {
    id: 'prod-009',
    ...
    variants: [{ name: 'Deep Green', price: 184.99 }],
    description: 'Yonex Nanoflare 800 Pro — explosive speed and accuracy.',
    specifications: { balance: 'Head-Light', player_level: 'Advanced Player' },
  },
  {
    id: 'prod-010',
    ...
    sale_price: 279.99,
    regular_price: null,
    variants: [{ name: 'Standard', price: 279.99 }],
    description:
      'Viktor Axelsen Limited Edition — the racket of a World Champion.',
    specifications: { player_level: 'Advanced Player', balance: 'Head-Heavy' },
  },
  {
    id: 'prod-011',
    ...
    sale_price: 134.99,
    regular_price: 175.0,
    variants: [{ name: 'Standard', price: 134.99 }],
    description: 'Yonex Astrox 88D Tour 3rd Gen — intermediate club level.',
    specifications: { player_level: 'Intermediate Club Player', strung: false },
  },
  {
    id: 'prod-012',
    ...
    sale_price: 199.99,
    regular_price: 249.99,
    variants: [{ name: 'Black/Green', price: 199.99 }],
  ...
  },
  {
    ...
    sale_price: 74.99,
    regular_price: null,
    variants: [{ name: 'Light Beige', price: 74.99 }],
  ...
  },
  {
    ...
    sale_price: 59.99,
    regular_price: null,
    variants: [{ name: 'Standard', price: 59.99 }],
    description:
      'Yonex Nanoflare 700 Play 2026 — fast and lightweight for beginners.',
    specifications: { player_level: 'Developing Player' },
  },
  {
    id: 'prod-015',
    ...
    sale_price: 49.99,
    regular_price: null,
    variants: [{ name: 'Light Beige', price: 49.99 }],
  ...
  },
  {
    ...
    variants: [
      { name: 'Yellow', price: 109.99 },
      { name: 'White', price: 109.99 },
    ],
    description:
      'Li-Ning Windstorm 74 — aerodynamic frame for intermediate players.',
    specifications: { player_level: 'Intermediate Club Player', strung: false },
  },
  {
    id: 'prod-017',
    ...
    sale_price: 99.99,
    regular_price: null,
    variants: [{ name: 'Standard', price: 99.99 }],
  ...
  },
  {
    ...
    variants: [{ name: 'Gold', price: 169.99 }],
  ...
  },
  {
    ...
    sale_price: 169.99,
    regular_price: 209.99,
    variants: [{ name: 'Blue', price: 169.99 }],
  ...
  },
  {
    ...
    sale_price: 174.99,
    regular_price: null,
    variants: [{ name: 'Standard', price: 174.99 }],
  ...
  },
  {
    ...
    sale_price: 187.99,
    regular_price: 209.99,
    variants: [{ name: 'Blue', price: 187.99 }],
  ...
  },
  {
    ...
    variants: [{ name: 'Standard', price: 149.99 }],
    description: 'Victor Auraspeed Fantome — lightning-fast head-light racket.',
    specifications: { player_level: 'Advanced Player', balance: 'Head-Light' },
  },
  {
    id: 'prod-023',
    ...
    sale_price: 139.99,
    regular_price: 199.99,
    variants: [{ name: 'Metallic C', price: 139.99 }],
  ...
  },
  {
    ...
    sale_price: 169.99,
    regular_price: 209.99,
    variants: [{ name: '4UG5', price: 169.99 }],
    description:
      'Victor Auraspeed Fantome Limited 4UG5 — exclusive speed racket.',
    specifications: { player_level: 'Advanced Player' },
  },
  {
    id: 'prod-025',
    ...
    specifications: { player_level: 'Beginner', strung: true },
  },
  {
    id: 'prod-026',
    ...
    regular_price: 209.99,
    variants: [
      { name: 'G1', price: 184.99 },
      { name: 'G2', price: 184.99 },
      { name: 'G3', price: 184.99 },
      { name: 'G4', price: 184.99 },
    ],
    description: 'Babolat Pure Drive 2025 — most popular tennis racket.',
    specifications: { player_level: 'Intermediate/Advanced', strung: true },
  },
  {
    id: 'prod-027',
    ...
    regular_price: 199.99,
    variants: [
      { name: 'G2', price: 179.99 },
      { name: 'G3', price: 179.99 },
    ],
    description:
      'Babolat Pure Drive Team Gen11 — lighter version of Pure Drive.',
    specifications: { strung: true },
  },
  {
    id: 'prod-028',
    ...
    regular_price: null,
    variants: [
      { name: 'G2', price: 129.99 },
      { name: 'G3', price: 129.99 },
    ],
  ...
  },
  {
    ...
    variants: [
      { name: 'G2 Mint', price: 99.99 },
      { name: 'G3 Mint', price: 99.99 },
    ],
    description:
      'Head IG Challenge Team Mint — comfortable intermediate racket.',
    specifications: { player_level: 'Intermediate', strung: true },
  },
  {
    id: 'prod-032',
    ...
    regular_price: null,
    variants: [
      { name: 'G2', price: 174.99 },
      { name: 'G3', price: 174.99 },
    ],
    description: 'Head Radical MP 2025 — versatile all-court racket.',
    specifications: { player_level: 'Advanced', strung: false },
  },
  {
    id: 'prod-033',
  ...
  },
  {
    ...
    sale_price: 269.99,
    regular_price: null,
    variants: [{ name: 'Ruby Red', price: 269.99 }],
    description: 'Yonex VCORE 100 2026 — spin-focused advanced racket.',
    specifications: { strung: false, player_level: 'Advanced' },
  },
  {
    id: 'prod-035',
    ...
    sale_price: 234.99,
    regular_price: null,
    variants: [{ name: 'Ruby Red', price: 234.99 }],
  ...
  },
  {
    ...
    sale_price: 189.99,
    regular_price: 199.99,
    variants: [{ name: 'Sand Beige', price: 189.99 }],
  ...
  },
  {
    ...
    sale_price: 54.99,
    regular_price: 84.99,
    variants: [{ name: 'Silver', price: 54.99 }],
    description: 'Dunlop Tristorm Elite 270 — lightweight beginner racket.',
    specifications: { player_level: 'Beginner' },
  },
  {
    id: 'prod-038',
    ...
    regular_price: null,
    variants: [
      { name: 'G2', price: 239.99 },
      { name: 'G3', price: 239.99 },
    ],
    description:
      'Babolat Pure Aero Team Gen 9 2026 — aerodynamic and powerful.',
    specifications: { player_level: 'Advanced' },
  },
  {
    id: 'prod-039',
    ...
    sale_price: 94.99,
    regular_price: null,
    variants: [{ name: 'Standard', price: 94.99 }],
    description:
      'Adidas RX Series Light 2026 — fiberglass padel racket for beginners.',
    specifications: {
      material: 'Fiberglass',
  ...
  },
  {
    ...
    sale_price: 154.99,
    regular_price: null,
    variants: [{ name: 'Standard', price: 154.99 }],
    description:
      'Adidas Metalbone Team Light 2026 — carbon padel for intermediates.',
    specifications: {
      material: 'Carbon',
      player_level: 'Intermediate Club Player',
    },
  ...
  },
  {
    ...
    sale_price: 199.99,
    regular_price: 229.99,
    variants: [{ name: 'Standard', price: 199.99 }],
    description:
      'Adidas Metalbone Carbon 2026 — high performance carbon padel.',
    specifications: { material: 'Carbon', player_level: 'Advanced Player' },
  },
  {
    id: 'prod-043',
    ...
    variants: [{ name: 'Standard', price: 300.0 }],
  ...
  },
  {
    ...
    variants: [{ name: 'Standard', price: 199.99 }],
    description:
      'Adidas Metalbone Carbon Ctrl 2026 — control-focused advanced padel.',
    specifications: { material: 'Carbon', player_level: 'Advanced Player' },
  },
  {
    id: 'prod-045',
    ...
    sale_price: 310.0,
    regular_price: 350.0,
    variants: [{ name: 'Standard', price: 310.0 }],
  ...
  },
  {
    ...
    sale_price: 219.99,
    regular_price: 349.99,
    variants: [{ name: 'Standard', price: 219.99 }],
    description:
      'Adidas Cross It CTRL 3.4 2025 — control padel at a great price.',
    specifications: { player_level: 'Intermediate Club Player' },
  },
  {
    id: 'prod-047',
    ...
    sale_price: 189.99,
    regular_price: null,
    variants: [{ name: 'Standard', price: 189.99 }],
  ...
  },
  {
    ...
    sale_price: 79.99,
    regular_price: null,
    variants: [{ name: 'Standard', price: 79.99 }],
  ...
  },
  {
    ...
    sale_price: 159.99,
    regular_price: null,
    variants: [{ name: 'Standard', price: 159.99 }],
  ...
  },
  {
    ...
    variants: [{ name: 'Standard', price: 199.99 }],
    description:
      'Babolat Technical Veron 3.0 2026 — head-heavy advanced padel.',
    specifications: {
      material: 'Carbon',
      player_level: 'Advanced Player',
      balance: 'Head-Heavy',
  ...
  },
  {
    ...
    sale_price: 69.99,
    regular_price: null,
    variants: [{ name: 'Standard', price: 69.99 }],
  ...
  },
  {
    ...
    sale_price: 209.99,
    regular_price: null,
    variants: [{ name: 'Standard', price: 209.99 }],
  ...
  },
  {
    ...
    sale_price: 249.99,
    regular_price: null,
    variants: [{ name: 'Standard', price: 249.99 }],
    description:
      'Babolat Technical Viper Soft 3.0 — soft core for better feel.',
    specifications: { material: 'Carbon', player_level: 'Advanced Player' },
  },
  {
    id: 'prod-057',
    ...
    sale_price: 299.99,
    regular_price: null,
    variants: [{ name: 'Standard', price: 299.99 }],
  ...
  },
  {
    ...
    sale_price: 294.99,
    regular_price: null,
    variants: [{ name: 'Standard', price: 294.99 }],
  ...
  },
  {
    ...
    sale_price: 259.99,
    regular_price: null,
    variants: [{ name: 'Standard', price: 259.99 }],
  ...
  },
  {
    ...
    sale_price: 284.99,
    regular_price: null,
    variants: [{ name: 'Standard', price: 284.99 }],
  ...
  },
  {
    ...
    sale_price: 224.99,
    regular_price: null,
    variants: [{ name: 'Standard', price: 224.99 }],
...
export async function POST(req: NextRequest) {
  // SECURITY: this operation writes/overwrites the entire product catalog
  // using the server's own privileged admin API key. It must never be
  ...
  try {
    ...
    // Fill missing categories from DB
    const allCats = await medusaAdmin.admin.productCategory.list({ limit: 100 })
      ...
      try {
        ...
        const payload: any = {
          ...
          metadata: {
            ...
            // "String Upgrade (+1 Day)" is a required Yes/No choice shown
            // on smashuk.co for racket products only (badminton, tennis,
            // padel) — not shoes, bags, shuttlecocks, grips, or clothing.
            // It doesn't change price, just adds a processing-time note.
            string_upgrade_available: p.category_ids.some((cid: string) =>
              ['cat-001-01', 'cat-002-01', 'cat-003-01'].includes(cid),
            ),
            // Stored as a proper {label, value} array — this is what the
            // storefront's Specifications tab actually reads
            // (metadata.specs). Previously this spread `p.specifications`
            // flat into metadata (e.g. metadata.player_level,
            // metadata.balance), which the storefront never looked at, so
            // every seeded product's spec tab was empty.
            specs: Object.entries(p.specifications ?? {}).map(
              ([key, value]) => ({
                label: key
                  .replace(/_/g, ' ')
          ...
          options: [
            { title: 'Variant', values: p.variants.map((v: any) => v.name) },
          ],
          variants: p.variants.map((v: any) => ({
            title: v.name,
            options: { Variant: v.name },
            prices: [
              { amount: Math.round(v.price * 100) / 100, currency_code: 'gbp' },
            ],
          })),
        }
        ...
        // UPSERT: check if a product with this handle already exists —
        // without this, re-running the seed (e.g. after adding specs /
        // string_upgrade_available) would either error on the duplicate
        // handle or silently do nothing for already-seeded products.
        ...
        if (existing.products?.length > 0) {
          ...
          // Update metadata/description/images on the existing product.
          // Variants/options are left alone on update — recreating them
          // here risks breaking existing orders/inventory links to those
          // variant ids.
    ...
    return NextResponse.json({ success: true, log, created, updated, failed })
  } catch (err: any) {
    log.push(`FATAL: ${err.message}`)
    return NextResponse.json(
      { success: false, log, error: err.message },
      { status: 500 },
    )
  }
}
