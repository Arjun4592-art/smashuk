...
const FEATURES = [
  {
    ...
    items: [
      'Feather & nylon options',
      'Per-tube discounted rates',
      'For registered clubs & coaching programmes',
    ],
  },
  {
    icon: '🔁',
    ...
    items: [
      ...
      'Timed to your club nights',
      'Adjust quantity anytime',
    ],
  },
  {
    icon: '🎓',
    ...
    items: [
      'Special junior development rates',
      'Built for high-volume coaching use',
    ],
  },
  {
    icon: '📅',
