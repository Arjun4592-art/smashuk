// Small payment-method badges for the footer. These are simple
// brand-colored wordmark/icon badges (not the official trademarked
// artwork, which we don't have distribution rights to) — same approach
// as the brand logos in BrandsBar.tsx.
...
export const PAYMENT_METHODS: PaymentMethod[] = [
  {
    ...
    render: () => (
      <Badge bg='#ffffff'>
        <span
          className='italic font-black text-[11px] tracking-tight'
          style={{ color: '#1A1F71' }}
        >
          VISA
        </span>
      ...
      <Badge bg='#ffffff'>
        <span className='flex items-center gap-[1px]'>
          <svg width='11' height='11' viewBox='0 0 48 48'>
            <path
              fill='#4285F4'
              d='M24 9.5c3.5 0 6.6 1.2 9 3.6l6.7-6.7C35.7 2.5 30.2 0 24 0 14.6 0 6.5 5.4 2.5 13.2l7.8 6.1C12.2 13.1 17.6 9.5 24 9.5z'
            />
            <path
              fill='#34A853'
            ...
            <path
              fill='#FBBC05'
              d='M10.3 19.3c-.5 1.5-.8 3-.8 4.7s.3 3.2.8 4.7l-7.8 6c-1.6-3.2-2.5-6.8-2.5-10.7s.9-7.5 2.5-10.7l7.8 6z'
            />
            <path
              fill='#EA4335'
              d='M24 48c6.2 0 11.4-2 15.2-5.6l-7.3-5.7c-2 1.4-4.6 2.2-7.9 2.2-6.4 0-11.8-4.3-13.7-10.1l-7.8 6C6.5 42.6 14.6 48 24 48z'
            />
          </svg>
