    ...
    <div className='bg-white'>
      ...
      <div className='ls-hero ls-hero-noise relative text-white overflow-hidden'>
        <span
          ...
          style={{ width: 300, height: 300, top: '-10%', left: '-4%' }}
        />
        <span
          className='ls-hero-glow hidden md:block'
          style={{
        ...
        <div
          ...
          style={{
            backgroundImage:
              'radial-gradient(circle at 15% 20%, rgba(232,85,58,0.16) 0%, transparent 45%), radial-gradient(circle at 85% 80%, rgba(255,196,83,0.12) 0%, transparent 45%)',
          }}
        />
        <div
        ...
        <div className='relative max-w-6xl mx-auto px-6 pt-16 pb-16 grid md:grid-cols-[1.1fr_0.9fr] gap-10 items-start'>
          ...
          <div>
            ...
            <div className='ls-hero-cta flex flex-wrap gap-3'>
              <Link
                ...
                className='ls-btn-shine inline-flex items-center gap-2 bg-[#E8553A] hover:bg-[#D4441F] text-white font-montserrat font-bold px-7 py-3.5 rounded-full text-sm transition-colors shadow-[0_8px_24px_rgba(232,85,58,0.35)]'
              >
                Book Your Slot →
              </Link>
              <a
                href='#tension'
                className='inline-flex items-center gap-2 border border-white/25 hover:border-white/50 text-white/80 hover:text-white font-montserrat font-semibold px-7 py-3.5 rounded-full text-sm transition-colors'
              >
                Find My Tension
              </a>
            </div>
          ...
          <div className='relative mt-2'>
            <div
              className='ls-card rounded-3xl overflow-hidden border border-white/10 aspect-[4/3] relative'
              style={{
                background:
                  'linear-gradient(155deg, #12285C 0%, #0A1F44 55%, #081837 100%)',
              }}
            >
              <svg
              ...
              <div
                ...
                style={{
                  background:
                    'radial-gradient(circle at 30% 25%, rgba(232,85,58,0.35) 0%, transparent 55%)',
                }}
              />
              <div
                className='absolute inset-0'
                style={{
                  backgroundImage:
                    "url('/local-store/stringing-tennis-hero.jpg')",
                  backgroundSize: 'cover',
                  backgroundPosition: 'center',
                }}
                role='img'
                aria-label='Tennis racket stringing'
              />
          ...
          <div className='bg-[#F8F9FB] border border-gray-100 rounded-3xl p-8 md:p-10'>
            ...
            <div className='grid sm:grid-cols-2 gap-4'>
              {RESTRING_SIGNS.map((s) => (
                <div
                  key={s.title}
                  className='flex gap-3 bg-white rounded-xl border border-gray-100 px-5 py-4'
                >
        ...
        <section className='reveal'>
          ...
          <div className='space-y-4'>
            {STRING_TYPES.map((s) => (
              <div
                key={s.name}
                className='bg-white border border-gray-100 rounded-2xl p-6 grid md:grid-cols-[1fr_1.3fr] gap-6'
              >
                <div>
          ...
          <div className='grid sm:grid-cols-3 gap-5'>
            {CARE_TIPS.map((c) => {
              ...
              return (
                <div
                  key={c.title}
                  className='bg-[#F8F9FB] border border-gray-100 rounded-2xl p-6 text-center'
                >
