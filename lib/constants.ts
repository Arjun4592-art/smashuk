...
export const SITE_DESCRIPTION = 'Premium sports equipment for every athlete. Shop football, cricket, basketball, tennis gear and more.';
export const SITE_URL = process.env.NEXT_PUBLIC_SITE_URL ?? 'https://smash-pro.netlify.app';
...
export const DEFAULT_SEO = {
  ...
  keywords: ['sports equipment', 'football gear', 'cricket bat', 'basketball', 'tennis racket', 'running shoes', 'sports shop uk', 'racket sports store uk', 'smash racket pro'],
