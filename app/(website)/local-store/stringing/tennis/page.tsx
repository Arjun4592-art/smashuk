...
export const metadata = {
  ...
  description:
    'Professional tennis racket stringing from £18. Tension advice, popular string types (polyester, multifilament, hybrid setups), 24-hour or 40-minute express turnaround.',
  keywords:
...
const PROCESS = [
  {
    step: '1',
    title: 'Inspection',
    desc: 'Upon collection of your tennis racket, we conduct an initial inspection to check the overall condition of the racket.',
  },
  {
    step: '2',
    title: 'Consultation',
  ...
  return (
    <div className='bg-white'>
      <div className='relative bg-[#0A1F44] text-white overflow-hidden'>
        {/* TODO: replace with a photo of a tennis racket being strung */}
        <img
        ...
        <div className='relative max-w-5xl mx-auto px-4 py-14 text-center'>
          ...
          <div className='flex flex-wrap items-center justify-center gap-x-8 gap-y-2 mt-8 text-sm font-montserrat font-semibold text-white/80'>
            ...
            <span className='w-1 h-1 rounded-full bg-white/30 hidden sm:block' />
            <span>Over 100+ String Options</span>
          </div>
        </div>
      </div>
      ...
      <div className='max-w-5xl mx-auto px-4 py-14'>
        ...
        <div className='mb-14'>
          ...
          <p className='text-gray-500 font-lato text-center mb-8 max-w-xl mx-auto'>
            Prices start from £18 and go up to £35 — all inclusive.
          </p>
          <div className='max-w-2xl mx-auto divide-y divide-gray-100 border-t border-b border-gray-100'>
            {STRING_BRANDS.map((b, i) => (
              <details key={b.brand} className='group py-4' open={i === 0}>
                ...
                {b.intro && (
                  <p className='text-sm text-gray-500 font-lato leading-relaxed mt-3 mb-2'>
                    {b.intro}
                  </p>
                )}
                ...
                {b.groups ? (
                  <div className='mt-2 space-y-4'>
                    {b.groups.map((g) => (
                      <div key={g.label}>
                        <p className='text-xs font-montserrat font-bold text-[#0A1F44] mb-1.5'>
                          {g.label}
                        </p>
        ...
        <div className='mb-14'>
          ...
          <p className='text-gray-500 font-lato text-center mb-8 max-w-xl mx-auto'>
            Want to read more about string types, patterns and choosing the
            right setup? Check out our guides.
          </p>
          <Link
          ...
          >
            <div className='aspect-[16/9] bg-gray-100'>
              <img
                src='https://images.unsplash.com/photo-1595435742656-5272d0b3fa82?w=1200&q=80'
                alt='Tennis Racket Grip Size: How to Get It Right'
