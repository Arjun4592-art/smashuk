...
const STRING_TYPES = [
  {
    name: 'Thick-Gauge Repel',
    best: 'Beginners & hard hitters wanting durability',
    power: 4,
    control: 3,
    durability: 5,
    feel: 2,
    note: 'A more durable repulsion string that holds up to heavier swings and mis-hits without sacrificing much pop.',
  },
  {
