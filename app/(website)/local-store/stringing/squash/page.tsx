...
import { SQUASH_TENSIONS as TENSIONS, SQUASH_STRINGS as STRINGS, SQUASH_BRANDS as BRANDS } from '@/lib/stringing-options';
...
export const metadata = {
  ...
  description: 'Professional squash racket stringing from £22. Tension advice for beginner to advanced players, popular string types in stock, 24-hour or 40-minute express turnaround.',
  keywords: 'squash stringing service, squash racket restring, squash string tension guide, squash restring manchester, squash string types'
};
const Icon = ({
  glyph,
  ...p
...
const IconRepeat = (p: React.SVGProps<SVGSVGElement>) => <Icon {...p} glyph={<>
...
export default async function SquashStringingPage() {
  ...
  const primaryAddress = [contact.address.line1, contact.address.line2, contact.address.city, contact.address.pincode].filter(Boolean).join(', ');
  return <div className='bg-[#F5F3EF] min-h-screen'>
          ...
          <div className='grid md:grid-cols-2 gap-12 items-end'>
            <div>
              ...
              <div className='flex flex-wrap gap-3'>
                <a href='#enquire' className='bg-[#E8553A] hover:bg-[#D4441F] text-white px-7 py-3.5 rounded-full text-sm font-montserrat font-bold transition-colors'>
                  Enquire Now →
                </a>
      ...
      <div className='max-w-4xl mx-auto px-4 md:px-6 py-16 space-y-20'>
          ...
          <div className='bg-[#0A1F44] rounded-3xl p-8 md:p-10 relative overflow-hidden'>
            ...
            <div className='relative'>
              ...
              <div className='grid sm:grid-cols-2 gap-4 max-w-2xl mx-auto'>
                {NEEDS_RESTRING.map(n => <div key={n.title} className='flex items-start gap-3 bg-white/5 border border-white/10 rounded-xl px-4 py-3.5'>
        ...
        {}
        <section id='enquire' className='reveal bg-[#F8F9FB] rounded-3xl p-6 md:p-12 -mx-4 sm:mx-0'>
          ...
          <div className='max-w-md mx-auto bg-white border border-gray-100 rounded-2xl p-8 flex flex-col items-center text-center gap-4'>
            <p className='text-gray-500 text-sm leading-relaxed'>
              Book your squash racket stringing slot on our online booking
              system.
            </p>
        ...
        <section id='tension'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-5'>
            {TENSIONS.map((t, i) => <div key={t.level} className={`rounded-2xl p-6 border ${i === 1 ? 'bg-[#0A1F44] border-[#0A1F44] text-white' : 'bg-white border-[#0A1F44]/8'}`}>
        ...
        <section className='reveal grid grid-cols-1 md:grid-cols-2 gap-5'>
          ...
          <div className='bg-[#E8553A] rounded-2xl p-8 text-white flex flex-col justify-between'>
            ...
            <a href='#enquire' className='inline-block mt-6 bg-white text-[#E8553A] font-montserrat font-bold px-5 py-2.5 rounded-full text-sm hover:bg-white/90 transition-colors w-fit'>
              Enquire Now →
            </a>
          </div>
        </section>
