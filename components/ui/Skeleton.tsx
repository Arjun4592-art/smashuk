...
// Reusable skeleton loading components for website, dashboard, and POS
...
export function CartItemSkeleton() {
  return (
    <div className='bg-white rounded-2xl p-5 border border-gray-100 flex gap-4 animate-pulse'>
...
export function OrderCardSkeleton() {
  return (
    <div className='bg-white rounded-2xl p-5 border border-gray-100 animate-pulse flex items-center gap-4'>
  ...
  return (
    <div className='animate-pulse'>
      {Array.from({ length: rows }).map((_, i) => (
        <div key={i} className={`flex gap-4 px-4 py-3 ${i !== rows - 1 ? 'border-b border-[#F1F1F1]' : ''}`}>
...
export function DashboardStatsSkeleton() {
  return (
    <div className='grid grid-cols-2 lg:grid-cols-4 gap-4 animate-pulse'>
      {[...Array(4)].map((_, i) => (
        <div key={i} className='bg-white border border-[#E1E3E5] rounded-2xl p-5'>
...
export function DashboardProductCardSkeleton() {
  return (
    <div className='bg-white border border-[#E1E3E5] rounded-xl p-4 animate-pulse flex gap-3'>
...
export function POSProductCardSkeleton() {
  return (
    <div className='bg-white border border-[#E1E3E5] rounded-xl p-3 animate-pulse'>
...
export function POSProductGridSkeleton({ count = 12 }: { count?: number }) {
  return (
    <div className='grid grid-cols-2 sm:grid-cols-3 gap-2.5 p-2'>
      {Array.from({ length: count }).map((_, i) => (
...
export function POSOrderRowSkeleton() {
  return (
    <div className='flex items-center gap-3 px-4 py-3.5 border-b border-[#F1F1F1] animate-pulse'>
  ...
  return (
    <div className='p-4 space-y-4 animate-pulse'>
      <div className='grid grid-cols-2 gap-3'>
        {[...Array(4)].map((_, i) => (
          <div key={i} className='bg-white border border-[#E1E3E5] rounded-xl p-4'>
