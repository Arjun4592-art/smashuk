...
const IconVan = (p: React.SVGProps<SVGSVGElement>) => (
  <Icon
    {...p}
    glyph={
      <>
...
const IconRacket = (p: React.SVGProps<SVGSVGElement>) => (
  <Icon
    {...p}
    glyph={
      <>
...
const IconShield = (p: React.SVGProps<SVGSVGElement>) => (
  <Icon
    {...p}
    glyph={<path d='M12 2 4 5v6c0 5.25 3.4 9.74 8 11 4.6-1.26 8-5.75 8-11V5z' />}
  />
)
...
export default function ClubDemoProgrammePage() {
  return (
    <div className='bg-[#F5F3EF] min-h-screen'>
      {/* ── HERO (grid-texture navy, no image) ──────────────────────── */}
      ...
      <div className='max-w-5xl mx-auto px-4 md:px-6 py-16 space-y-20'>
        ...
        <section className='reveal'>
          ...
          <StringingTimeline
            steps={HOW_IT_WORKS.map((h) => ({ ...h, icon: <h.icon /> }))}
          />
        </section>
        ...
        <section>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-5'>
            {SPORTS.map((s) => (
              <div
                key={s.title}
                className='bg-white rounded-2xl p-6 border border-[#0A1F44]/8'
              >
                ...
                <div className='flex flex-wrap gap-1.5'>
                  {s.tags.map((t) => (
                    <span
                      key={t}
                      className='text-[10px] font-montserrat font-semibold text-[#0A1F44] bg-[#F5F3EF] border border-[#0A1F44]/8 rounded-full px-2.5 py-1'
                    >
                      {t}
                    </span>
                  ))}
        ...
        {/* ── WHO BENEFITS — members & club side by side ───────────────── */}
        <section>
          <div className='text-center mb-10'>
            ...
            <div className='relative grid md:grid-cols-[1.2fr_1fr] gap-10 items-center'>
              <div>
                ...
                <p className='text-white/60 text-xs mt-4'>
                  Or email us at{' '}
                  <a
                    href='mailto:partnership@smashuk.co'
