      ...
      >
        ...
        >
          ...
          <div className='overflow-y-auto flex-1'>
            ...
            {order.note && (
              <div className='px-4 pt-4'>
                ...
                <div
                  className='rounded-xl p-3'
                  style={{ border: '1px solid #E1E3E5', background: '#FFFBEB' }}
                >
          ...
          >
            ...
            <button
              onClick={handlePrint}
              className='w-full py-3 rounded-lg text-sm font-medium border transition-colors hover:bg-[#F6F6F7] flex items-center justify-center gap-2'
            ...
            {!order.returned && !isAwaitingPickup(order) && !canFulfill && (
              <button
                onClick={onReturn}
                className='w-full py-3 rounded-lg text-sm font-semibold border transition-colors hover:bg-[#FFF4F4] flex items-center justify-center gap-2'
