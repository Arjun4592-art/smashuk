      ...
      boxShadow: '0 8px 32px rgba(0,0,0,0.12)'
        ...
        borderBottom: '1px solid #E1E3E5'
          ...
          <div className='flex items-center gap-2'>
            {view !== 'list' && <button onClick={() => setView('list')} className='w-7 h-7 flex items-center justify-center rounded hover:bg-[#F6F6F7]' style={{
            color: '#6D7175'
          }}>
            ...
            color: '#202223'
              ...
              {view === 'list' ? 'Staff management' : view === 'add' ? 'Add staff member' : view === 'edit' ? 'Edit staff member' : 'Change PIN'}
            </h3>
          </div>
        ...
        {error && <div className='mx-5 mt-3 px-3 py-2 rounded-lg text-xs' style={{
        background: '#FFF4F4',
        color: '#D82C0D'
      }}>
            {error}
        ...
        {view === 'list' && <>
            ...
            borderColor: '#E1E3E5'
                ...
                <input value={search} onChange={e => setSearch(e.target.value)} placeholder='Search staff...' className='flex-1 bg-transparent outline-none text-sm' style={{
              color: '#202223'
            }} />
              </div>
              <button onClick={openAdd} className='flex items-center gap-1.5 px-3 py-2 rounded-lg text-sm font-medium' style={{
            background: '#008060',
            color: '#FFFFFF'
          }}>
          ...
          maxHeight: 400
              ...
              {loading ? <div className='py-8 flex justify-center'>
                ...
                </div> : filtered.length === 0 ? <p className='text-sm text-center py-8' style={{
            color: '#8C9196'
          }}>
                  No staff found.
                </p> : filtered.map(staff => {
            const role = roleInfo(staff.role);
            return <div key={staff.id} className='flex items-center gap-3 px-5 py-3 hover:bg-[#F6F6F7] transition-colors' style={{
              borderBottom: '1px solid #F6F6F7'
                ...
                color: role.color
                    ...
                    color: role.color
                          ...
                          {!staff.isActive && <span className='text-[10px] px-1.5 py-0.5 rounded-full font-medium' style={{
                    background: '#F6F6F7',
                    color: '#8C9196'
                  }}>
                              Inactive
                  ...
                  color: '#8C9196'
                      ...
                      <div className='flex items-center gap-1 shrink-0'>
                        <button onClick={() => openPin(staff)} className='px-2 py-1 rounded text-xs border transition-colors hover:border-[#008060] hover:text-[#008060]' style={{
                  borderColor: '#E1E3E5',
                  color: '#6D7175'
                }}>
                          PIN
                        </button>
                        <button onClick={() => openEdit(staff)} className='w-7 h-7 flex items-center justify-center rounded transition-colors hover:bg-[#F6F6F7]' style={{
                  color: '#6D7175'
                }}>
                        ...
                        <button onClick={() => handleRemove(staff.id)} className='w-7 h-7 flex items-center justify-center rounded transition-colors hover:bg-[#FFF4F4]' style={{
                  color: '#8C9196'
        ...
        {}
        {(view === 'add' || view === 'edit') && <>
            <div className='p-5 space-y-3 overflow-y-auto' style={{
          maxHeight: 440
        }}>
              <div className='grid grid-cols-2 gap-3'>
                ...
                color: '#6D7175'
                  ...
                  <input autoFocus value={form.name} onChange={e => setForm({
                ...form,
                name: e.target.value
              })} placeholder='e.g. Rahul Sharma' className='w-full px-3 py-2 rounded-lg border text-sm outline-none focus:border-[#008060]' style={{
                borderColor: '#E1E3E5',
                color: '#202223'
              }} />
                </div>
              ...
              })} placeholder='••••••' maxLength={6} className='w-full px-3 py-2 rounded-lg border text-sm outline-none focus:border-[#008060]' style={{
                borderColor: '#E1E3E5',
                color: '#202223'
              }} />
                  </div>}
              ...
              })} placeholder='+44 7700 900000' className='w-full px-3 py-2 rounded-lg border text-sm outline-none focus:border-[#008060]' style={{
                borderColor: '#E1E3E5',
                color: '#202223'
              }} />
                </div>
              ...
              })} placeholder='staff@smashuk.co.uk' className='w-full px-3 py-2 rounded-lg border text-sm outline-none focus:border-[#008060]' style={{
                borderColor: '#E1E3E5',
                color: '#202223'
              }} />
                </div>
                ...
                color: '#202223'
                  ...
                  <p className='text-[10.5px] mt-1' style={{
                color: '#8C9196'
              }}>
              ...
              color: '#6D7175'
            }}>Staff member is active</span>
              </label>
            </div>

            <div className='px-5 pb-5 flex gap-2' style={{
          borderTop: '1px solid #E1E3E5',
          paddingTop: 12
        }}>
              <button onClick={() => setView('list')} className='flex-1 py-2.5 rounded-lg text-sm border hover:bg-[#F6F6F7]' style={{
            borderColor: '#E1E3E5',
            color: '#6D7175'
          }}>
                Cancel
              </button>
              <button onClick={handleSave} disabled={saving || !form.name.trim() || view === 'add' && form.pin.length !== 6} className='flex-1 py-2.5 rounded-lg text-sm font-medium disabled:opacity-50' style={{
            background: '#008060',
            color: '#FFFFFF'
          }}>
        ...
        {view === 'pin' && selected && <>
            ...
            background: '#F6F6F7'
              ...
              color: roleInfo(selected.role).color
                ...
                color: '#202223'
                  ...
                  <p className='text-xs' style={{
                color: '#8C9196'
              }}>{roleInfo(selected.role).label}</p>
                </div>
              </div>
          ...
          paddingTop: 12
            ...
            color: '#6D7175'
              ...
              <button onClick={handlePinChange} disabled={saving} className='flex-1 py-2.5 rounded-lg text-sm font-medium disabled:opacity-50' style={{
            background: '#008060',
            color: '#FFFFFF'
          }}>
