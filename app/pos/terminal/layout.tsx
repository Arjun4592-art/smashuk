...
export default function POSTerminalLayout({
  ...
  return (
    <AuthProvider surface='pos'>
      <div
        className='pos-terminal-shell flex flex-col h-[100dvh] overflow-hidden'
        style={{
          background: '#F6F6F7',
        }}
      >
        ...
        <main
          className='pos-terminal-main flex-1 min-h-0 overflow-hidden transition-opacity duration-200 flex flex-col'
          style={{
