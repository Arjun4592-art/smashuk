      ...
      <div className='min-h-screen bg-[#F2F4F7]'>
        ...
        <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 grid grid-cols-1 lg:grid-cols-3 gap-6'>
          ...
          <div className='space-y-4'>
            ...
            {}
            <a
              href={`/api/store/orders/${order.id}/invoice`}
              target='_blank'
              rel='noopener noreferrer'
              className='block w-full bg-white rounded-2xl border border-gray-100 p-5 text-left hover:shadow-md transition-shadow'
            >
