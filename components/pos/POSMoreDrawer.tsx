'use client'
// BUG FIX: React 19 dropped the global `JSX` namespace, so `JSX.Element`
// below no longer resolves and was failing `next build` (TS2503: Cannot
// find namespace 'JSX'). Import the type explicitly instead.
...
export default function POSMoreDrawer({
  ...
  const MORE_ITEMS: {
    ...
    },
    {
      id: 'staff',
      label: 'Staff',
      // Only POS managers (role 'admin') can manage other staff members' PINs
      // and roles — a cashier shouldn't see this at all.
  ...
  return (
    <>
      ...
      >
        ...
        {/* Staff header card — tap to view profile */}
        <div
          className='mx-4 mt-2 mb-3 rounded-xl overflow-hidden'
        ...
        {/* Sign out */}
        <div
          className='mx-4 mt-3 mb-2 rounded-xl overflow-hidden'
          style={{ background: '#FFFFFF' }}
        >
          <button
            onClick={() => {
