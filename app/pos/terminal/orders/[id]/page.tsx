          ...
          {!isPickup &&
            ...
            order.fulfillment_status !== 'canceled' && (
              <button
                ...
                className='inline-flex items-center gap-1.5 px-4 py-2 rounded-xl text-[13px] font-semibold transition-all cursor-pointer border border-[#2C6ECB] text-[#2C6ECB] bg-white disabled:opacity-50'
              >
                {labelLoading ? Icons.spinner : null}
