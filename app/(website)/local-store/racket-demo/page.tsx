...
export const metadata = {
  ...
  description: 'Test premium rackets before you buy! Demo the latest badminton, tennis, and padel rackets from top brands. £10 per racket with refundable deposit. Book your demo session today.',
  keywords: 'racket demo service, try before you buy racket, badminton racket trial, tennis racket demo, padel racket demo, racket demo manchester, test a racket before buying'
};
const SPORTS = [{
  icon: '🏸',
  title: 'Badminton',
  ...
  brands: [{
    brand: 'Victor',
    items: ['Victor Thruster Ryuga Metallic', 'Victor Thruster Ryuga II Pro B', 'Victor Auraspeed 90K Metallic R', 'Victor Auraspeed HS Plus B', 'Victor Drive X 10 Metallic', 'Victor Thruster F Ultra (New)', 'Victor Auraspeed Fantome (New)']
  }, {
    brand: 'Yonex',
    items: ['Yonex ArcSaber 11 Pro 3U', 'Yonex ArcSaber 11 Pro 4U', 'Yonex Astrox 100 ZZ KRNI 4U', 'Yonex Astrox 88D Pro (3rd Gen) 4U', 'Yonex Astrox 88SPro (3rd Gen) 4U', 'Yonex Nanoflare 700 Pro 4U', 'Yonex Nanoflare 1000Z 4U', 'Yonex Nanoflare 800 Pro 3U', 'Yonex Nanoflare 800 Pro 4U']
  }, {
    brand: 'Li-Ning',
  ...
  brands: [{
    brand: 'Babolat',
    items: ['Pure Drive Gen 11', 'Pure Drive Team Gen 11', 'Pure Aero', 'Pure Aero Team', 'Pure Strike 100 2024', 'Pure Strike Team 2024', 'Evo Drive Gen 11', 'Evo Drive Lite Gen 11', 'Evo Drive Tour Gen 11', 'Evo Aero']
  }, {
    brand: 'Yonex',
  ...
  return <div className='bg-[#F5F3EF] min-h-screen'>
      ...
      <section className='reveal max-w-5xl mx-auto px-4 md:px-6 py-16'>
        ...
        <div className='hidden md:flex gap-0 relative mb-4'>
          ...
          {HOW_IT_WORKS.map(p => <div key={p.n} className='flex-1 flex flex-col items-center px-3'>
        ...
        <div className='md:hidden space-y-0 relative mb-6'>
          ...
          {HOW_IT_WORKS.map(p => <div key={p.n} className='flex gap-6 py-5'>
      ...
      <section className='reveal bg-white border-y border-[#0A1F44]/8'>
        <div className='max-w-5xl mx-auto px-4 md:px-6 py-16'>
          ...
          <div className='grid md:grid-cols-3 gap-6'>
            {SPORTS.map(s => <div key={s.title} className='bg-[#F5F3EF] rounded-2xl border border-[#0A1F44]/8 p-6'>
                ...
                {s.comingSoon ? <p className='text-xs text-gray-400 text-center italic'>
                    Coming soon — contact us for availability
                  </p> : <DemoBrandAccordion brands={s.brands} />}
              </div>)}
          </div>
          <p className='text-center text-sm text-gray-400 mt-8'>
            📞 Need help? Give us a call or drop us an email at{' '}
            <a href='mailto:sales@smashuk.co' className='text-[#E8553A] font-semibold'>
              sales@smashuk.co
            </a>
          </p>
        </div>
      ...
      <section className='reveal max-w-5xl mx-auto px-4 md:px-6 pb-16'>
        ...
        <div className='grid sm:grid-cols-2 md:grid-cols-4 gap-px bg-[#0A1F44]/6 border border-[#0A1F44]/6 rounded-2xl overflow-hidden'>
          {WHY_DEMO.map(w => <div key={w.title} className='bg-white p-6 hover:bg-[#F5F3EF] transition-colors text-center'>
