...
export function SearchIcon({
  ...
  return <svg width={size} height={size} viewBox='0 0 24 24' fill='none' stroke='currentColor' strokeWidth='1.5' strokeLinecap='round' strokeLinejoin='round' className={className}>
...
export function HeartIcon({
  ...
  return <svg width={size} height={size} viewBox='0 0 24 24' fill={filled ? 'currentColor' : 'none'} stroke='currentColor' strokeWidth='1.5' strokeLinecap='round' strokeLinejoin='round' className={className}>
...
export function TwitterIcon({
  ...
  return <svg width={size} height={size} viewBox='0 0 24 24' fill='currentColor' className={className}>
...
export function LoadingIcon({
  ...
  return <svg width={size} height={size} viewBox='0 0 24 24' fill='none' stroke='currentColor' strokeWidth='1.5' strokeLinecap='round' strokeLinejoin='round' className={`animate-spin ${className}`}>
...
export function DiscountTotalIcon({
  size = 20,
  className = ''
}: IconProps) {
  return <svg width={size} height={size} viewBox='0 0 24 24' fill='none' stroke='currentColor' strokeWidth='1.5' strokeLinecap='round' strokeLinejoin='round' className={className}>
...
export function SpinnerIcon({
  ...
  return <svg width={size} height={size} viewBox='0 0 24 24' fill='none' className={`animate-spin ${className}`}>
